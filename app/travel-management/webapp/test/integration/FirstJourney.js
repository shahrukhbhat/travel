sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheTravelList.onTable().iCheckColumns(5, {"destination":{"header":"Destination"},"startDate":{"header":"Start Date"},"endDate":{"header":"End Date"},"totalPrice":{"header":"Total Price"},"status":{"header":"Status"}});
