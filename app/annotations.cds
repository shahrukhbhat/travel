...
annotate travelSrv.Travel with @UI.HeaderInfo: { TypeName: 'Travel', TypeNamePlural: 'Travels' };
...
annotate travelSrv.Travel with @UI.Facets: [
  ...
  { $Type : 'UI.ReferenceFacet', ID : 'Booking', Target : 'bookings/@UI.LineItem' }
];

annotate travelSrv.User with @UI.HeaderInfo: { TypeName: 'User', TypeNamePlural: 'Users', Title: { Value: username } };
annotate travelSrv.User with {
  ID @UI.Hidden @Common.Text: { $value: username, ![@UI.TextArrangement]: #TextOnly }
};
...
annotate travelSrv.User with @UI.SelectionFields: [
  username
];

annotate travelSrv.Booking with @UI.HeaderInfo: { TypeName: 'Booking', TypeNamePlural: 'Bookings', Title: { Value: bookingId } };
...
annotate travelSrv.Booking with @UI.LineItem: [
 ...
 { $Type: 'UI.DataField', Value: price },
    { $Type: 'UI.DataField', Label: 'User', Value: user_ID }
];
...
annotate travelSrv.Booking with {
  user @Common.Text: { $value: user.username, ![@UI.TextArrangement]: #TextOnly }
};
